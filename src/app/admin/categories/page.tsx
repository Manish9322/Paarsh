  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-900">
      ...
      <div className="fixed left-0 right-0 top-0 z-50 flex h-16 items-center justify-between bg-white px-4 shadow-sm dark:bg-gray-800 dark:text-white md:hidden">
        ...
        <h1 className="text-lg font-bold text-gray-800 dark:text-white">Categories Management</h1>
        <button
          onClick={toggleTheme}
          className="rounded-full p-2 text-gray-600 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                  ...
                  <Table className="w-full text-black dark:text-white">
                    <TableHeader>
                      <TableRow className="border-b border-gray-200 bg-gray-50 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:hover:bg-gray-800">
                        ...
                        <TableHead className="hidden py-3 sm:table-cell">Created At</TableHead>
                    ...
                    <div className="space-y-4">
                      <div className="overflow-hidden rounded-lg border border-gray-100 transition-all hover:shadow-md dark:border-gray-700">
                        <div className="bg-gray-50 px-4 py-2 dark:bg-gray-700">
                          <h3 className="font-medium text-gray-700 dark:text-gray-300">Basic Information</h3>
                        </div>
                        <div className="divide-y divide-gray-100 dark:divide-gray-700">
                          <div className="grid grid-cols-3 px-4 py-3">
                            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Category Name</span>
                            <span className="col-span-2 text-sm text-gray-900 dark:text-gray-200">{selectedCategory.name}</span>
                          </div>
                          <div className="grid grid-cols-3 px-4 py-3">
                            ...
                            <span className="col-span-2 text-sm text-gray-900 dark:text-gray-200">
                              {new Date(selectedCategory.createdAt).toLocaleDateString(undefined, {
                                year: 'numeric',
                                month: 'long',
                                day: 'numeric'
                              })}
