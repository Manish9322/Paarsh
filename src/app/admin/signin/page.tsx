...
import { setCredentials, setError } from "../../../lib/slices/authSlice";
...
const SigninPage = () => {
  ...
  return (
    <section className="relative z-10 min-h-screen flex items-center justify-center p-6">
      <div className="shadow-lg mx-auto max-w-[500px] rounded-lg bg-white px-6 py-10 dark:bg-dark sm:p-[60px]">
        ...
        <form onSubmit={handleLogin}>
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full mt-2 px-4 py-3 border rounded-md focus:ring focus:ring-blue-300"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full px-4 py-3 text-white bg-blue-700 rounded-md hover:bg-blue-600 transition duration-300"
            disabled={isLoading}
          >
      ...
      <div className="absolute left-0 -top-44 z-[-1]">
          <svg
            width="1440"
            height="969"
