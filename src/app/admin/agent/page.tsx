...
import { ChevronUp, ChevronDown, Eye, Edit, Trash2, Menu, ChevronLeft, ChevronRight } from "lucide-react";
                              ...
                              >
                                ...
                                <TableCell>
                                  <div className="sm:hidden">
                                    ...
                                    <p className="text-xs text-gray-500">Contact: {agent.mobile}</p>
                                    <p className="text-xs text-gray-500">Sales: {agent.countSale}</p>
                                  </div>
                                  <span className="hidden sm:inline">{agent.firstName}</span>
                                </TableCell>
                                <TableCell className="hidden sm:table-cell">{agent.lastName}</TableCell>
                                <TableCell className="hidden sm:table-cell">{agent.mobile}</TableCell>
                                <TableCell className="hidden md:table-cell">{agent.countSale}</TableCell>
                                <TableCell className="hidden lg:table-cell">{agent.state}</TableCell>
                                <TableCell>
                                  <div className="flex items-center justify-center gap-2">
                                    ...
                                    >
                                      ...
                                      <span className="absolute -bottom-8 left-1/2 z-10 min-w-max -translate-x-1/2 transform rounded bg-gray-800 px-2 py-1 text-xs text-white opacity-0 shadow-lg transition-opacity group-hover:opacity-100 dark:bg-gray-700">Edit agent</span>
                                    </button>
                                    <button
                                    ...
                                    >
                                      ...
                                      <span className="absolute -bottom-8 left-1/2 z-10 min-w-max -translate-x-1/2 transform rounded bg-gray-800 px-2 py-1 text-xs text-white opacity-0 shadow-lg transition-opacity group-hover:opacity-100 dark:bg-gray-700">Delete agent</span>
                                    </button>
                                  </div>
                                </TableCell>
                              </TableRow>
            ...
            <Dialog open={viewOpen} onOpenChange={setViewOpen}>
              <DialogContent className="max-h-[90vh] max-w-md overflow-y-auto rounded-lg bg-white p-0 shadow-lg dark:bg-gray-800 dark:text-white">
                <DialogHeader className="sticky top-0 z-10 border-b bg-white px-6 py-4 dark:bg-gray-800 dark:border-gray-700">
                  <DialogTitle className="text-xl font-bold text-gray-800 dark:text-white">Agent Details</DialogTitle>
                </DialogHeader>
                {selectedAgent ? (
                  <div className="p-6">
                    <div className="mb-6 flex items-center justify-center">
                      <div className="flex h-20 w-20 items-center justify-center rounded-full bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
                        <span className="text-2xl font-bold">{selectedAgent.firstName.charAt(0)}{selectedAgent.lastName.charAt(0)}</span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="overflow-hidden rounded-lg border border-gray-100 transition-all hover:shadow-md dark:border-gray-700">
                        ...
                        <div className="divide-y divide-gray-100 dark:divide-gray-700">
                          <div className="grid grid-cols-3 px-4 py-3">
                            ...
                            <span className="col-span-2 text-sm text-gray-900 dark:text-gray-200">{selectedAgent.id}</span>
                          </div>
                          <div className="grid grid-cols-3 px-4 py-3">
                            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Full Name</span>
                            <span className="col-span-2 text-sm text-gray-900 dark:text-gray-200">{selectedAgent.firstName} {selectedAgent.lastName}</span>
                          </div>
                          <div className="grid grid-cols-3 px-4 py-3">
                            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Contact</span>
                            <span className="col-span-2 text-sm text-gray-900 dark:text-gray-200">{selectedAgent.mobile}</span>
                          </div>
                          <div className="grid grid-cols-3 px-4 py-3">
                            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">State</span>
                            <span className="col-span-2 text-sm text-gray-900 dark:text-gray-200">{selectedAgent.state}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="overflow-hidden rounded-lg border border-gray-100 transition-all hover:shadow-md dark:border-gray-700">
                        ...
                        <div className="divide-y divide-gray-100 dark:divide-gray-700">
                          <div className="grid grid-cols-3 px-4 py-3">
                            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Sales Count</span>
                            <div className="col-span-2 flex items-center">
                              <span className="text-sm text-gray-900 dark:text-gray-200">{selectedAgent.countSale}</span>
                              <div className="ml-2 h-2 w-24 overflow-hidden rounded-full bg-gray-200 dark:bg-gray-600">
                                <div 
                                  className="h-full rounded-full bg-blue-500" 
                                  style={{ width: `${Math.min(selectedAgent.countSale * 5, 100)}%` }}
                                ></div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="overflow-hidden rounded-lg border border-gray-100 transition-all hover:shadow-md dark:border-gray-700">
                        <div className="bg-gray-50 px-4 py-2 dark:bg-gray-700">
                          <h3 className="font-medium text-gray-700 dark:text-gray-300">System Information</h3>
                        </div>
                        <div className="divide-y divide-gray-100 dark:divide-gray-700">
                          <div className="grid grid-cols-3 px-4 py-3">
                            ...
                            <span className="col-span-2 text-sm text-gray-900 dark:text-gray-200">
                              {new Date(selectedAgent.createdAt).toLocaleDateString(undefined, {
                                year: 'numeric',
                                month: 'long',
                                day: 'numeric'
                              })}
                  ...
                  <div className="flex h-40 items-center justify-center">
                    <p className="text-center text-gray-500 dark:text-gray-400">No agent selected.</p>
                  </div>
                )}
              </DialogContent>
            </Dialog>
            ...
            <div className="mt-6 rounded-lg bg-white p-4 shadow-md dark:bg-gray-800 dark:text-white">
              <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  ...
                  of <span className="font-medium text-gray-700 dark:text-gray-300">{sortedAgents.length}</span> agents
                </div>
