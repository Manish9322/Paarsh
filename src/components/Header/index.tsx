        ...
        <ul className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col md:flex-row items-center mb-4 md:mb-0">
            <li className="phone flex items-center mb-2 md:mb-0 md:mr-6">
              ...
              <p className="text-gray-100 dark:text-primary dark:hover:text-primary">
                +91 90752 01035
              </p>
            </li>
              ...
              <ul className="flex items-center">
                <li className="flex items-center hover:text-white">
                  <a
                    ...
                    className="mr-6 text-gray-100 duration-300 hover:text-white dark:text-primary dark:hover:text-primary"
                  >
                    <svg
                      width="24"
                      height="24"
                ...
                {/* <li className="flex items-center">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-100 duration-300 hover:text-white dark:text-primary dark:hover:text-primary"
                  >
                    <svg
                      width="24"
                      height="24"
